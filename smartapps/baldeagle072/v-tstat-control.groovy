 ...
 */
definition(
    name: "V-TStat Control",
    namespace: "baldeagle072",
    author: "Eric Roberts",
    description: "To control ronnycarr's virtual thermostat device ",
...
preferences {
	section("Virtual Thermostat") {
		input "vTstat", "capability.thermostat", title: "Virtual T-Stat", required: true, multiple: false
	}
    section("Sensors") {
